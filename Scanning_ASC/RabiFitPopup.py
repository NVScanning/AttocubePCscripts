...
class RabiFitPopup(tk.Toplevel):
    ...
    def create_widgets(self):
        ...
        ttk.Label(self.inputs_frame, text="Init Time (µs)").grid(row=0, column=0, padx=5, pady=5, sticky="w")
        self.init_time_entry = ttk.Entry(self.inputs_frame)
        self.init_time_entry.grid(row=0, column=1, padx=5, pady=5)
        self.init_time_entry.insert(0, "5.0")

        ttk.Label(self.inputs_frame, text="Pulse Spacing (ns)").grid(row=0, column=2, padx=5, pady=5, sticky="w")
        self.pulse_spacing_entry = ttk.Entry(self.inputs_frame)
        self.pulse_spacing_entry.grid(row=0, column=3, padx=5, pady=5)
        self.pulse_spacing_entry.insert(0, "100")

        ttk.Label(self.inputs_frame, text="N Pulses").grid(row=0, column=4, padx=5, pady=5, sticky="w")
        self.n_pulses_entry = ttk.Entry(self.inputs_frame)
        self.n_pulses_entry.grid(row=0, column=5, padx=5, pady=5)
        self.n_pulses_entry.insert(0, "50")

        ttk.Label(self.inputs_frame, text="N Avg").grid(row=1, column=0, padx=5, pady=5, sticky="w")
        self.n_avg_entry = ttk.Entry(self.inputs_frame)
        self.n_avg_entry.grid(row=1, column=1, padx=5, pady=5)
        self.n_avg_entry.insert(0, "10")

        ttk.Label(self.inputs_frame, text="RF Power (dBm)").grid(row=1, column=2, padx=5, pady=5, sticky="w")
        self.rf_power_entry = ttk.Entry(self.inputs_frame)
        self.rf_power_entry.grid(row=1, column=3, padx=5, pady=5)
        ...
        ttk.Label(self.display_frame, text="Rabi Frequency (MHz):", font=("Helvetica", 12), bg="white").grid(row=0, column=0, padx=10, pady=5)
        ...
        ttk.Label(self.display_frame, text="Decay (ns):", font=("Helvetica", 12), bg="white").grid(row=1, column=0, padx=10, pady=5)
        ...
        ttk.Label(self.display_frame, text="Contrast:", font=("Helvetica", 12), bg="white").grid(row=2, column=0, padx=10, pady=5)
        ...
        ttk.Label(self.display_frame, text="Time Elapsed (s):", font=("Helvetica", 12), bg="white").grid(row=3, column=0, padx=10, pady=5)
    ...
    def start_rabi(self):
        params = {
            "rf_freq": self.rabi_module.rabi_params["rf_freq"],  # preloaded from popup
